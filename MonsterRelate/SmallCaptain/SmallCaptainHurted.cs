...
public class SmallCaptainHurted : MonoBehaviour
{
    ...
    private SmallCaptainController _controller;
    ...
    void Start()
    {
        ...
        _controller = this.GetComponent<SmallCaptainController>();
        ...
        for (int i = 0; i < SpriteNumber; i++)
        {
            SummonSprList[i] = this.transform.GetChild(10).GetChild(0).GetChild(i).GetComponent<SpriteRenderer>();
        }
    }
    ...
    void Update()
    {
        if (_hurtedController.isHurted)
        {
            ...
            {
                case SmallCaptainController.AniStatus.Wait:
                    for (int i = 0; i < SpriteNumber; i++)
                    {
                        MoveSprList[i].color = new Color(0.65f, 0.48f, 0.48f, 1);
                    }
                    break;
                case SmallCaptainController.AniStatus.Walk:
                    for (int i = 0; i < SpriteNumber; i++)
                    {
                        MoveSprList[i].color = new Color(0.65f, 0.48f, 0.48f, 1);
                    }
                    break;
                case SmallCaptainController.AniStatus.Atk:
                    for (int i = 0; i < SpriteNumber; i++)
                    {
                        AtkSprList[i].color = new Color(0.65f, 0.48f, 0.48f, 1);
                    }
                    break;
                case SmallCaptainController.AniStatus.Atk2:
                    for (int i = 0; i < SpriteNumber; i++)
                    {
                        Atk2SprList[i].color = new Color(0.65f, 0.48f, 0.48f, 1);
                    }
                    break;
                case SmallCaptainController.AniStatus.Atk3:
                    for (int i = 0; i < SpriteNumber; i++)
                    {
                        Atk3SprList[i].color = new Color(0.65f, 0.48f, 0.48f, Atk3SprList[i].color.a);
                    }
                    break;
                case SmallCaptainController.AniStatus.SlowMove:
                    for (int i = 0; i < SpriteNumber; i++)
                    {
                        SlowWalkSprList[i].color = new Color(0.65f, 0.48f, 0.48f, 1);
                    }
                    break;
                case SmallCaptainController.AniStatus.Jump:
                    for (int i = 0; i < SpriteNumber; i++)
                    {
                        JumpSprList[i].color = new Color(0.65f, 0.48f, 0.48f, 1);
                    }
                    break;
                case SmallCaptainController.AniStatus.Summon:
                    for (int i = 0; i < SpriteNumber; i++)
                    {
        ...
        else
        {
            switch (_controller.NowAni)
            {
                ...
                case SmallCaptainController.AniStatus.Atk3:
                    for (int i = 0; i < SpriteNumber; i++)
                    {
                        Atk3SprList[i].color = new Color(1, 1, 1, Atk3SprList[i].color.a);
                    }
                    break;
                case SmallCaptainController.AniStatus.SlowMove:
                    for (int i = 0; i < SpriteNumber; i++)
