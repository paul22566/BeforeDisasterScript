...
public class FinalAtk4 : MonoBehaviour
{
    private float Timer = 3.4f;
    private float TimerSet = 3.4f;
    ...
    void Start()
    {
        ...
        Object8 = this.transform.GetChild(9).gameObject;
        Object9 = this.transform.GetChild(10).gameObject;
        Object10 = this.transform.GetChild(11).gameObject;
        Object11 = this.transform.GetChild(12).gameObject;
    }
