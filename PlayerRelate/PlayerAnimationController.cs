...
public class PlayerAnimationController : MonoBehaviour
{
    ...
    private ThrowItemAniChange NormalThrowAni;
    private ThrowItemAniChange MoveThrowAni;
    private ThrowItemAniChange JumpThrowAni;
    ...
    void Start()
    {
       ...
       NormalThrowAni = PlayerThrowAnimation.GetComponent<ThrowItemAniChange>();
        MoveThrowAni = PlayerMoveAnimation.GetComponent<ThrowItemAniChange>();
        JumpThrowAni = PlayerJumpAnimation.GetComponent<ThrowItemAniChange>();
    ...
    {
        if (PlayerController.face == PlayerController.Face.Right)
        {
            PlayerController.face = PlayerController.Face.Left;
        }
        if (PlayerController.face == PlayerController.Face.Left)
        {
    ...
    public void SwitchFace(string Face)
    {
        switch (Face)
        {
            case "R":
